...
namespace Skyray.EDXRFLibrary
{
    ...
    public abstract partial class Spec : DbObjectModel<Spec>
    {
        ...
        [Auto("管流")]
        public abstract double TubCurrent { get; set; }
        ...
        public abstract Spec Init(
            ...
            double UsedTime,
            double TubVoltage,
            double TubCurrent, string RemarkInfo);
        ...
        public SpecEntity ConvertSpecToNew()
        {
            SpecEntity speEntiy = new SpecEntity();
            speEntiy.DeviceParameter = this.DeviceParameter.ConvertFrom();
            speEntiy.Name = Name;
            speEntiy.SpecData = SpecData;
            speEntiy.SpecTime = SpecTime;
            speEntiy.UsedTime = UsedTime;
            speEntiy.TubCurrent = TubCurrent;
            speEntiy.TubVoltage = TubVoltage;
            speEntiy.RemarkInfo = RemarkInfo;
            speEntiy.IsSmooth = IsSmooth;
            return speEntiy;
        }
