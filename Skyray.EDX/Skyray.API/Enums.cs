...
namespace Skyray.API
{
    ...
    public enum ReflectedMessages
    {
        ...
        OCM_CTLCOLORWinMsgBOX = (OCM__BASE + WinMsgs.WM_CTLCOLORWinMsgBOX),
    ...
    public enum HitTest
    {
        ...
        /// (same as public const int HTNOWHERE, except that the DefWindowProc function produces a system beep to indicate an error).
        /// </summary>
        HTERROR = (-2),
        /// <summary>
