...
namespace Skyray.UC //AllocationRequest
{
    /// <summary>
    ...
    public class DGVPrinter
    {
        ...
        public void PrintDataGridView(DataGridViewW dgv)
        {
            if (null == dgv) throw new Exception("Null Parameter passed to DGVPrinter.");
            if (typeof(DataGridViewW) != dgv.GetType())
        ...
        public void PrintPreviewDataGridView(DataGridViewW dgv)
        {
            if (null == dgv) throw new Exception("Null Parameter passed to DGVPrinter.");
            if (typeof(DataGridViewW) != dgv.GetType())
                throw new Exception("Invalid Parameter passed to DGVPrinter.");
        ...
        public void PrintNoDisplay(DataGridViewW dgv)
        {
            if (null == dgv) throw new Exception("Null Parameter passed to DGVPrinter.");
            if (typeof(DataGridViewW) != dgv.GetType())
                throw new Exception("Invalid Parameter passed to DGVPrinter.");
        ...
        /// </summary>
        /// <param name="dgv"></param>
        public void PrintPreviewNoDisplay(DataGridViewW dgv)
        {
            if (null == dgv) throw new Exception("Null Parameter passed to DGVPrinter.");
            if (typeof(DataGridViewW) != dgv.GetType())
                throw new Exception("Invalid Parameter passed to DGVPrinter.");
        ...
        public bool EmbeddedPrint(DataGridViewW dgv, Graphics g, Rectangle area)
        {
