...
namespace Skyray.Controls.Extension
{
    ...
    public class XRFChart : ZedGraphControl
    {
        #region fields
        ...
        private ContextMenuStrip cmsPeakMenu;
        private IContainer components;
        private ToolStripMenuItem tsmiNewPeak;
        private ToolStripMenuItem tsmiDelPeak;
        private ToolStripMenuItem tsmiLeftBorder;
        private ToolStripMenuItem tsmiRightBorder;
        private ToolStripMenuItem tsmiBaseLeft;
        private ToolStripMenuItem tsmiBaseRight;
        private ToolStripMenuItem tsmiReduction;
        ...
        private ToolStripMenuItem tsmiHorizontalAsynchronous;
        private ToolStripMenuItem tsmiVerticalAsynchronous;
        private ToolStripMenuItem tsmiDelInterestArea;
        private ToolStripMenuItem tsmVirtual;
        /// <summary>
        /// 当前感兴趣区域
        /// </summary>
        ...
        public bool IsRadiation
        {
            set
            {
                this.grpRadiation.Visible = value;
            }
        }
        ...
        private bool iMeasure;
        public bool IMeasure
        {
            set
            {
                if (value != iMeasure)
                {
                    if (value)
                    {
                        this.grpRadiation.BackgroundImage = global::Skyray.Controls.Extension.Resource.radiation1;
                    }
                    else
                    {
                        this.grpRadiation.BackgroundImage = global::Skyray.Controls.Extension.Resource.radiation2;
                    }
                    iMeasure = value;
                }
            }
        ...
        private Grouper grpRadiation;
        private ToolStripMenuItem tsmiUpSpec;
        private ToolStripMenuItem tsmiDownSpec;
...
#if !DesignMode
        [Browsable(false), DefaultValue(null)]
        public List<DemarcateEnergy> DemarcateEnergys
        {
            get { return demarcateEnergys; }
            set
            {
                demarcateEnergys = value;
                if (demarcateEnergys != null)
                {
...
#endif
        [Browsable(false), DefaultValue(null)]
        public DbObjectList<Atom> Atoms
        {
            get { return atoms; }
            set { atoms = value; }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.cmsPeakMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
            this.tsmiNewPeak = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiDelPeak = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiLeftBorder = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiRightBorder = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiBaseLeft = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiBaseRight = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiUpSpec = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiDownSpec = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiReduction = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmVirtual = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiBackColor = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiHorizontalAsynchronous = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiVerticalAsynchronous = new System.Windows.Forms.ToolStripMenuItem();
            this.tsmiDelInterestArea = new System.Windows.Forms.ToolStripMenuItem();
            this.grpRadiation = new Skyray.Controls.Grouper();
            ...
            this.cmsPeakMenu.SuspendLayout();
            this.SuspendLayout();
            // 
            // cmsPeakMenu
            // 
            this.cmsPeakMenu.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.tsmiNewPeak,
            this.tsmiDelPeak,
            this.tsmiLeftBorder,
            this.tsmiRightBorder,
            this.tsmiBaseLeft,
            this.tsmiBaseRight,
            this.tsmiUpSpec,
            this.tsmiDownSpec,
            ...
            this.tsmVirtual,
            this.tsmiBackColor,
            this.tsmiHorizontalAsynchronous,
            this.tsmiVerticalAsynchronous,
            this.tsmiDelInterestArea});
            this.cmsPeakMenu.Name = "cmsPeakMenu";
            this.cmsPeakMenu.Size = new System.Drawing.Size(153, 334);
            // 
            // tsmiNewPeak
            // 
            this.tsmiNewPeak.Name = "tsmiNewPeak";
            this.tsmiNewPeak.Size = new System.Drawing.Size(152, 22);
            this.tsmiNewPeak.Text = "添加峰标识";
            this.tsmiNewPeak.Click += new System.EventHandler(this.tsmiNewPeak_Click);
            // 
            // tsmiDelPeak
            // 
            this.tsmiDelPeak.Name = "tsmiDelPeak";
            this.tsmiDelPeak.Size = new System.Drawing.Size(152, 22);
            this.tsmiDelPeak.Text = "删除峰标识";
            this.tsmiDelPeak.Click += new System.EventHandler(this.tsmiDelPeak_Click);
            // 
            // tsmiLeftBorder
            // 
            this.tsmiLeftBorder.Name = "tsmiLeftBorder";
            this.tsmiLeftBorder.Size = new System.Drawing.Size(152, 22);
            this.tsmiLeftBorder.Text = "左边界";
            this.tsmiLeftBorder.Visible = false;
            this.tsmiLeftBorder.Click += new System.EventHandler(this.tsmiLeftBorder_Click);
            // 
            // tsmiRightBorder
            // 
            this.tsmiRightBorder.Name = "tsmiRightBorder";
            this.tsmiRightBorder.Size = new System.Drawing.Size(152, 22);
            this.tsmiRightBorder.Text = "右边界";
            this.tsmiRightBorder.Visible = false;
            this.tsmiRightBorder.Click += new System.EventHandler(this.tsmiRightBorder_Click);
            // 
            // tsmiBaseLeft
            // 
            this.tsmiBaseLeft.Name = "tsmiBaseLeft";
            this.tsmiBaseLeft.Size = new System.Drawing.Size(152, 22);
            this.tsmiBaseLeft.Text = "背景左界";
            this.tsmiBaseLeft.Visible = false;
            this.tsmiBaseLeft.Click += new System.EventHandler(this.tsmiBaseLeft_Click);
            // 
            // tsmiBaseRight
            // 
            this.tsmiBaseRight.Name = "tsmiBaseRight";
            this.tsmiBaseRight.Size = new System.Drawing.Size(152, 22);
            this.tsmiBaseRight.Text = "背景右界";
            this.tsmiBaseRight.Visible = false;
            this.tsmiBaseRight.Click += new System.EventHandler(this.tsmiBaseRight_Click);
            // 
            // tsmiUpSpec
            // 
            this.tsmiUpSpec.Name = "tsmiUpSpec";
            this.tsmiUpSpec.Size = new System.Drawing.Size(152, 22);
            this.tsmiUpSpec.Text = "上拉谱(+)";
            this.tsmiUpSpec.Click += new System.EventHandler(this.tsmiUpSpec_Click);
            // 
            // tsmiDownSpec
            // 
            this.tsmiDownSpec.Name = "tsmiDownSpec";
            this.tsmiDownSpec.Size = new System.Drawing.Size(152, 22);
            this.tsmiDownSpec.Text = "下拉谱(-)";
            this.tsmiDownSpec.Click += new System.EventHandler(this.tsmiDownSpec_Click);
            // 
            // tsmiReduction
            // 
            this.tsmiReduction.Name = "tsmiReduction";
            this.tsmiReduction.Size = new System.Drawing.Size(152, 22);
            this.tsmiReduction.Text = "还原";
            this.tsmiReduction.Visible = false;
            this.tsmiReduction.Click += new System.EventHandler(this.tsmiReduction_Click);
            // 
            // tsmVirtual
            // 
            this.tsmVirtual.Name = "tsmVirtual";
            this.tsmVirtual.Size = new System.Drawing.Size(152, 22);
            this.tsmVirtual.Text = "对比谱";
            this.tsmVirtual.Click += new System.EventHandler(this.tsmVirtual_Click);
            // 
            // tsmiBackColor
            // 
            this.tsmiBackColor.Name = "tsmiBackColor";
            this.tsmiBackColor.Size = new System.Drawing.Size(152, 22);
            this.tsmiBackColor.Text = "背景颜色";
            this.tsmiBackColor.Click += new System.EventHandler(this.tsmiBackColor_Click);
            // 
            // tsmiHorizontalAsynchronous
            // 
            this.tsmiHorizontalAsynchronous.Name = "tsmiHorizontalAsynchronous";
            this.tsmiHorizontalAsynchronous.Size = new System.Drawing.Size(152, 22);
            this.tsmiHorizontalAsynchronous.Text = "水平异步";
            this.tsmiHorizontalAsynchronous.Click += new System.EventHandler(this.tsmiHorizontalAsynchronous_Click);
            // 
            // tsmiVerticalAsynchronous
            // 
            this.tsmiVerticalAsynchronous.Name = "tsmiVerticalAsynchronous";
            this.tsmiVerticalAsynchronous.Size = new System.Drawing.Size(152, 22);
            this.tsmiVerticalAsynchronous.Text = "垂直异步";
            this.tsmiVerticalAsynchronous.Click += new System.EventHandler(this.tsmiVerticalAsynchronous_Click);
            // 
            // tsmiDelInterestArea
            // 
            this.tsmiDelInterestArea.Name = "tsmiDelInterestArea";
            this.tsmiDelInterestArea.Size = new System.Drawing.Size(152, 22);
            this.tsmiDelInterestArea.Text = "删除感兴趣区";
            this.tsmiDelInterestArea.Visible = false;
            this.tsmiDelInterestArea.Click += new System.EventHandler(this.tsmiDelInterestArea_Click);
            // 
            // grpRadiation
            // 
            this.grpRadiation.BackgroundColor = System.Drawing.Color.Transparent;
            this.grpRadiation.BackgroundGradientColor = System.Drawing.Color.Transparent;
            this.grpRadiation.BackgroundGradientMode = Skyray.Controls.Grouper.GroupBoxGradientMode.None;
            this.grpRadiation.BackgroundImage = global::Skyray.Controls.Extension.Resource.radiation2;
            this.grpRadiation.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
            this.grpRadiation.BorderColor = System.Drawing.Color.Transparent;
            this.grpRadiation.BorderThickness = 1F;
            this.grpRadiation.BorderTopOnly = false;
            this.grpRadiation.CustomGroupBoxColor = System.Drawing.Color.Transparent;
            this.grpRadiation.GroupBoxAlign = Skyray.Controls.Grouper.GroupBoxAlignMode.Center;
            this.grpRadiation.GroupImage = null;
            this.grpRadiation.GroupTitle = "";
            this.grpRadiation.HeaderRoundCorners = 4;
            this.grpRadiation.Location = new System.Drawing.Point(353, 17);
            this.grpRadiation.Name = "grpRadiation";
            this.grpRadiation.PaintGroupBox = false;
            this.grpRadiation.RoundCorners = 4;
            this.grpRadiation.ShadowColor = System.Drawing.Color.DarkGray;
            this.grpRadiation.ShadowControl = false;
            this.grpRadiation.ShadowThickness = 3;
            this.grpRadiation.Size = new System.Drawing.Size(80, 80);
            this.grpRadiation.TabIndex = 8;
            this.grpRadiation.TextLineSpace = 2;
            this.grpRadiation.TitleLeftSpace = 18;
            this.grpRadiation.Visible = false;
            // 
            // btnReduction
            // 
            ...
            this.btnReduction.Location = new System.Drawing.Point(90, 49);
            ...
            this.btnDown.Location = new System.Drawing.Point(90, 74);
            ...
            this.btnUp.Location = new System.Drawing.Point(90, 24);
            ...
            this.btnRight.Location = new System.Drawing.Point(115, 49);
            ...
            this.btnLeft.Location = new System.Drawing.Point(65, 49);
            ...
            // XRFChart
            // 
            this.Controls.Add(this.grpRadiation);
            ...
            this.Controls.SetChildIndex(this.grpRadiation, 0);
            this.cmsPeakMenu.ResumeLayout(false);
        ...
        /// <param name="e"></param>
        private void tsmiNewPeak_Click(object sender, EventArgs e)
        {
            FrmAddPeak frm = new FrmAddPeak();
            if (frm.ShowDialog() == DialogResult.OK)
            {
                var at = Atoms.Find(a => a.AtomName == frm.SelectElement);
                double ener = 0;
                switch (frm.Line)
                {
                    case XLine.Ka:
                ...
                //ReadyAddDE = DemarcateEnergy.New.Init(frm.SelectElement, frm.Line, dEnergy, iCurrentChannel);
                ReadyAddDE = DemarcateEnergy.New.Init(frm.SelectElement, frm.Line, ener, iCurrentChannel);
                if (OnAddPeakFlag != null)
                {
                    OnAddPeakFlag(frm.CustomChannel, null);
                    DemarcateEnergys = this.DemarcateEnergys;
                    //setElementPeakFlag();
                }
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void tsmiDelPeak_Click(object sender, EventArgs e)
        {
            if (OnDelPeakFlag != null)
            {
                OnDelPeakFlag(this, null);
                DemarcateEnergys = this.DemarcateEnergys;
                //setElementPeakFlag();
            }
        }
        ...
        {
            this.Focus();
            if (DemarcateEnergys == null) return;
            if (e.Button == MouseButtons.Right)
            {
                cmsPeakMenu.Items["tsmiBackColor"].Text = XRFInfo.BackColor;
                cmsPeakMenu.Items["tsmiHorizontalAsynchronous"].Text = XRFInfo.HorizontalAsynchronous;
                cmsPeakMenu.Items["tsmiVerticalAsynchronous"].Text = XRFInfo.VerticalAsynchronous;
                cmsPeakMenu.Items["tsmiDelInterestArea"].Text = XRFInfo.DelInterestArea;
                cmsPeakMenu.Items["tsmiReduction"].Text = XRFInfo.Reduction;
                cmsPeakMenu.Items["tsmiReduction"].Visible = true;

                cmsPeakMenu.Items["tsmVirtual"].Text = XRFInfo.Virtual;
                cmsPeakMenu.Items["tsmiUpSpec"].Text = XRFInfo.UpSpec;
                cmsPeakMenu.Items["tsmiDownSpec"].Text = XRFInfo.DownSpec;

                if (!IsAdmin)
                {
                    cmsPeakMenu.Items["tsmiBackColor"].Visible = false;
                }
                if (UnSpecing)
                {
                    if (_IUseBoundary)
                    {
                        cmsPeakMenu.Items["tsmiLeftBorder"].Text = boundaryElement + XRFInfo.LeftBoundary;
                        cmsPeakMenu.Items["tsmiRightBorder"].Text = boundaryElement + XRFInfo.RightBoundary;
                        cmsPeakMenu.Items["tsmiLeftBorder"].Visible = true;
                        cmsPeakMenu.Items["tsmiRightBorder"].Visible = true;
                    }
                    else
                    {
                        cmsPeakMenu.Items["tsmiLeftBorder"].Visible = false;
                        cmsPeakMenu.Items["tsmiRightBorder"].Visible = false;
                    }
                    if (_IUseBase)
                    {
                        cmsPeakMenu.Items["tsmiBaseLeft"].Text = boundaryElement + XRFInfo.BaseLeft;
                        cmsPeakMenu.Items["tsmiBaseRight"].Text = boundaryElement + XRFInfo.BaseRight;
                        cmsPeakMenu.Items["tsmiBaseLeft"].Visible = true;
                        cmsPeakMenu.Items["tsmiBaseRight"].Visible = true;
                    }
                    else
                    {
                        cmsPeakMenu.Items["tsmiBaseLeft"].Visible = false;
                        cmsPeakMenu.Items["tsmiBaseRight"].Visible = false;
                    }
                }
                else
                {
                ...
                {
                    bool flagP = false;
                    foreach (var de in DemarcateEnergys)
                    {
                        float xCoordy = this.MasterPane.PaneList[0].XAxis.Scale.Transform(de.Channel);
                        if (Math.Pow((e.X - xCoordy), 2) <= 25)
                        {
                            //显示菜单
                            readyDeleteDE = de;
                            cmsPeakMenu.Items["tsmiNewPeak"].Visible = false;
                            cmsPeakMenu.Items["tsmiDelPeak"].Text = XRFInfo.DeletePeak;
                            cmsPeakMenu.Items["tsmiDelPeak"].Visible = true;
                            flagP = true;
                            break;
                        }
                    }
                    if (!flagP)
                    {
                        cmsPeakMenu.Items["tsmiNewPeak"].Text = XRFInfo.AddPeak;
                        cmsPeakMenu.Items["tsmiNewPeak"].Visible = true;
                        cmsPeakMenu.Items["tsmiDelPeak"].Visible = false;
                        readyDeleteDE = null;
                    }
                }
                else
                ...
                cmsPeakMenu.Show(this.PointToScreen(e.Location));
                mouseX = -1;
                mouseY = -1;
            }
        }
                    ...
                    else
                    {
                        foreach (var sp in interestAreaList)
                        {
                            if ((iCurrentChannel >= sp.X1 && iCurrentChannel <= sp.X2) || (iCurrentChannel <= sp.X1 && iCurrentChannel >= sp.X2))
                            {
                                ...
                                SetSpecData(_workCurve, this._VirtualSpecList, _spec, _changescale, _defaultcolor, _growstyle);
                                tsmiDelInterestArea.Visible = true;
                                break;
                            }
                        }
                    }
        ...
        void MyZedGraph_SizeChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                mouseX = -1;
                mouseY = -1;
                this.grpRadiation.Location = new System.Drawing.Point(Width - 120, 26);
                ChangeScroll();
                this.ResumeLayout(false);
        ...
        {
            if (iYMaxChannel <= 0 || iXMaxChannel <= 0) return;
            ...
            this.MasterPane.PaneList[0].Y2Axis.Scale.Max = iYMaxChannel;
        ...
        private void tsmiHorizontalAsynchronous_Click(object sender, EventArgs e)
        {
            tsmiHorizontalAsynchronous.Checked = tsmiHorizontalAsynchronous.Checked ? false : true;
            if (tsmiHorizontalAsynchronous.Checked)
            {
                HorizontalSynchronization = false;
            }
            else
            {
                HorizontalSynchronization = true;
        ...
        private void tsmiVerticalAsynchronous_Click(object sender, EventArgs e)
        {
            tsmiVerticalAsynchronous.Checked = tsmiVerticalAsynchronous.Checked ? false : true;
            if (tsmiVerticalAsynchronous.Checked)
            {
        ...
        private void tsmiDelInterestArea_Click(object sender, EventArgs e)
        {
            ...
            tsmiDelInterestArea.Visible = false;
        ...
        private void DrawCurve(Graphics g)
        {
            try
            {
                ...
                {
                    this.GraphPane.YAxis.Scale.Max = ScalePoints.OrderByDescending(data => data.Y).ToList<PointF>()[0].Y * 1.1;
                    this.GraphPane.YAxis.Scale.Min = ScalePoints.OrderBy(data => data.Y).ToList<PointF>()[0].Y * 0.9;
                    this.GraphPane.XAxis.Scale.Max = ScalePoints.OrderByDescending(data => data.X).ToList<PointF>()[0].X * 1.1;
        ...
        /// 
        /// </summary>
        private void initElementLine()
        {
            if (Atoms == null)
            {
                return;
            }
            ElementLineDic.Clear();
            foreach (var dic in AtomNamesDic)
            {
                int key = dic.Key;
                string[] names = dic.Value;
                int[] lines;
                if (!AtomLinesDic.TryGetValue(key, out lines))
                { continue; }
                List<ElementLine> elementLineList = new List<ElementLine>();
                if (names != null)
                {
                    for (int i = 0; i < names.Length; i++)
                    {
                        Atom atom = Atoms.FindLast(a => a.AtomName == names[i]);
                        if (atom != null)
                        {
                            if (lines[i] == 0)//K系
                            {
                                setElementLine(atom.Ka, Color.FromArgb(int.Parse(atom.AtomColor)), atom.AtomName, "Ka", elementLineList, key);
                                setElementLine(atom.Kb, Color.FromArgb(int.Parse(atom.AtomColor)), atom.AtomName, "Kb", elementLineList, key);
                            }
                            else//L系
                            {
                                setElementLine(atom.La, Color.FromArgb(int.Parse(atom.AtomColor)), atom.AtomName, "La", elementLineList, key);
                                setElementLine(atom.Lb, Color.FromArgb(int.Parse(atom.AtomColor)), atom.AtomName, "Lb", elementLineList, key);
                                //setElementLine(atom.Le, Color.FromArgb(int.Parse(atom.AtomColor)), atom.AtomName, "Le");
                                //setElementLine(atom.Lr, Color.FromArgb(int.Parse(atom.AtomColor)), atom.AtomName, "Lr");
                            }
                        }
                    }
                }
                ElementLineDic.Add(key, elementLineList);
            }
        }
        ...
        private void drawSpec(GraphPane graphPane, SpecEntity spec)
        {
            ...
            if (Lssi != null && Lssi.Count > 0)
            {
                foreach (SpecSplitInfo ssi in Lssi)
                {
                    ...
                    //if (ViceSpecDataDic.Count > 0)
                    //{
                    //    PointPairList vppl = new PointPairList();
                    //    LineItem vli = graphPane.AddCurve("", vppl, Color.Yellow, SymbolType.None);
                    //    vli.Line.IsAntiAlias = true;
                    //    vli.Line.IsOptimizedDraw = true;
                    //    vli.Line.IsSmooth = true;
                    //    vli.Line.SmoothTension = 0.05f;
                    //    vli.Line.StepType = StepType.ForwardStep;
                    //    //vli.Line.Fill = new Fill(Color.Gray);
                    //    vli.Tag = "VSpec";
                    //    List<SpecData> vSpecDataList;
                    //    if (ViceSpecDataDic.TryGetValue(CurrentSpecPanel - 1, out vSpecDataList))
                    //    {
                    //        for (int i = ssi.X1; i <= ssi.X2; i++)
                    //        {
                    //            vppl.Add(vSpecDataList[i].dX, vSpecDataList[i].dY);
                    //        }
                    //    }
                    //}
                    ...
                    li.Line.SmoothTension = 0.05f;
                    li.Line.StepType = StepType.ForwardStep;
                    //FontSpec fontSpec = new FontSpec("", fontSize, ssi.Color, false, false, false);
        ...
        public GraphPane CreatePanel(WorkCurve WorkCurveCurrent, SpecEntity spec, Rectangle rect, Color color, bool isFill, bool isAlone, SpecListEntity specList, Color BackColor, List<SpecListEntity> specListVirtual)
        {
            ...
            if (dicVisual.Count != 0)
            {
                ...
                foreach (var div in dicVisual)
                {
                    ...
                    int[] intSpec = Helper.ToInts(div.Key.SpecData);
                    for (int i = 0; i < Points.Length; i++)
                    {
                        double x = i;
        ...
        /// setElementPeakFlag
        /// </summary>
        public void setElementPeakFlag()
        {
            elementPeakFlag = new List<ElementLine>();
            if (DemarcateEnergys == null || DemarcateEnergys.Count == 0)
                return;
            for (int i = 0; i < DemarcateEnergys.Count; i++)
            {
                setElementPeakFlag(DemarcateEnergys[i].Channel, Color.Black, DemarcateEnergys[i].ElementName, DemarcateEnergys[i].Line.ToString());
            }
        }
    ...
    public class HorizontalEventArgs : EventArgs
    {
