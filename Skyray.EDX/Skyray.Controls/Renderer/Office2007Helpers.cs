...
namespace Skyray.Controls
{
    ...
    /// </summary>
    public class UseAntiAlias_B : IDisposable
    {
        ...
        public UseAntiAlias_B(Graphics g)
        {
            _g = g;
    ...
    /// </summary>
    public class UseClearTypeGridFit_B : IDisposable
    {
        #region Instance Fields
        private Graphics _g;
        ...
        /// </summary>
        /// <param name="g">Graphics instance.</param>
        public UseClearTypeGridFit_B(Graphics g)
        {
            _g = g;
