...
namespace Skyray.Controls
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        public Office2007Renderer(ProfessionalColorTable table)
            :base(table)
        { 
        }
        #endregion
        ...
        protected override void OnRenderItemCheck(ToolStripItemImageRenderEventArgs e)
        {
            ...
            using (UseAntiAlias_B uaa = new UseAntiAlias_B(e.Graphics))
            {
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                using (UseClearTypeGridFit_B clearTypeGridFit = new UseClearTypeGridFit_B(e.Graphics))
        ...
        {
            // Drawing with anti aliasing to create smoother appearance
            using (UseAntiAlias_B uaa = new UseAntiAlias_B(g))
            {
