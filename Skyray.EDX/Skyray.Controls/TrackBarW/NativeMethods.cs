...
namespace Skyray.Controls
{
    internal class TNativeMethods
    {
        ...
        {
            public TNativeMethods.NMHDR hdr;
            public TNativeMethods.CustomDrawDrawStage dwDrawStage;
            public IntPtr hdc;
            public TNativeMethods.RECT rc;
            public IntPtr dwItemSpec;
            public TNativeMethods.CustomDrawItemState uItemState;
