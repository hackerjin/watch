namespace Skyray.Controls
{
    ...
    public class ScrollBarEx : Control
    {
        ...
        /// The border color.
        /// </summary>
        private Color borderColor = Color.FromArgb(157, 185, 235);
        ...
        /// CYH
        /// </summary>
        private ISkyrayControl renderer = new Office2007BlueRenderer();
        ...
        //private bool _KeyResponse = false;


        /// <summary>
        /// CYH
        /// </summary>
        public ISkyrayControl Renderer
        {
            get
            {
        ...
        public int Maximum
        {
            ...
            set
            {
                ...
                //    return;
                //}
                if (value == this.maximum || value < 0 || value < this.minimum)
                {
                    return;
                }
                this.maximum = value;
        ...
        public int Value
        {
            ...
            set
            {
                ...
                if (ValueChanged != null) ValueChanged(null, null);
            }
        }
