...
namespace Skyray.Controls
{
    ...
    /// </summary>
    public class Office2007BlueRenderer : ISkyrayControl
    {
        //public void DrawBackground(Object o,Object b,Object j)
        //{ }
        ...
        /// </summary>
        private Color[,] thumbColors = new Color[3, 8];

        /// <summary>
        /// The arrow colors in the three states.
        /// </summary>
        private Color[,] arrowColors = new Color[3, 8];

        /// <summary>
        /// The arrow border colors.
        /// </summary>
        private Color[] arrowBorderColors = new Color[4];
        ...
        /// The track colors.
        /// </summary>
        private Color[] trackColors = new Color[2];
        ...
        /// <summary>
        /// Initializes  members of the <see cref="Office2007Blue"/> class.
        /// </summary>
        public Office2007BlueRenderer()
        {
            // hot state
            thumbColors[0, 0] = Color.FromArgb(158, 190, 245);
            thumbColors[0, 1] = Color.FromArgb(175, 210, 255);
            thumbColors[0, 2] = Color.FromArgb(214, 238, 254);
            thumbColors[0, 3] = Color.FromArgb(233, 237, 242);
            //thumbColors[0, 4] = Color.FromArgb(227, 239, 255);
            //thumbColors[0, 5] = Color.FromArgb(199, 224, 255);
            //thumbColors[0, 6] = Color.FromArgb(173, 209, 255);
            thumbColors[0, 4] = Color.FromArgb(200, 223, 237, 255);
            thumbColors[0, 5] = Color.FromArgb(200, 175, 210, 255);
            thumbColors[0, 6] = Color.FromArgb(200, 197, 222, 255);
            thumbColors[0, 7] = Color.FromArgb(158, 190, 245);


            // over state
            thumbColors[1, 0] = Color.FromArgb(255, 196, 177, 118);
            thumbColors[1, 1] = Color.FromArgb(200, 255, 255, 178);
            thumbColors[1, 2] = Color.FromArgb(200, 255, 214, 108);
            thumbColors[1, 3] = Color.FromArgb(200, 255, 214, 108);
            thumbColors[1, 4] = Color.FromArgb(200, 255, 214, 78);
            thumbColors[1, 5] = Color.FromArgb(200, 255, 214, 108);
            thumbColors[1, 6] = Color.FromArgb(200, 255, 255, 178);
            thumbColors[1, 7] = Color.FromArgb(200, 255, 255, 178);
            // pressed state
            //thumbColors[2, 0] = Color.FromArgb(255, 128, 64, 0);
            //thumbColors[2, 1] = Color.FromArgb(200, 255, 178, 100);
            //thumbColors[2, 2] = Color.FromArgb(200, 255, 128, 30);
            //thumbColors[2, 3] = Color.FromArgb(200, 255, 128, 30);
            //thumbColors[2, 4] = Color.FromArgb(200, 255, 128, 0);
            //thumbColors[2, 5] = Color.FromArgb(200, 255, 128, 30);
            //thumbColors[2, 6] = Color.FromArgb(200, 255, 178, 100);
            //thumbColors[2, 7] = Color.FromArgb(200, 255, 178, 100);
            thumbColors[2, 0] = Color.FromArgb(255, 128, 64, 0);
            thumbColors[2, 1] = Color.FromArgb(200, 255, 171, 63);
            thumbColors[2, 2] = Color.FromArgb(200, 255, 198, 125);
            thumbColors[2, 3] = Color.FromArgb(200, 255, 198, 125);
            thumbColors[2, 4] = Color.FromArgb(200, 255, 198, 88);
            thumbColors[2, 5] = Color.FromArgb(200, 255, 198, 125);
            thumbColors[2, 6] = Color.FromArgb(200, 255, 171, 63);
            thumbColors[2, 7] = Color.FromArgb(200, 255, 171, 63);
            ...
            // hot state
            arrowColors[0, 0] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 1] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 2] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 3] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 4] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 5] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 6] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[0, 7] = Color.FromArgb(200, 255, 214, 108);

            // over state
            arrowColors[1, 0] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 1] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 2] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 3] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 4] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 5] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 6] = Color.FromArgb(200, 255, 214, 108);
            arrowColors[1, 7] = Color.FromArgb(200, 255, 214, 108);

            // pressed state
            arrowColors[2, 0] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 1] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 2] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 3] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 4] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 5] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 6] = Color.FromArgb(200, 255, 178, 100);
            arrowColors[2, 7] = Color.FromArgb(200, 255, 178, 100);
            ...
            //backgroundColors[3] = Color.FromArgb(175, 210, 255);//main
            //backgroundColors[4] = Color.FromArgb(240, 240, 240);

            backgroundColors[2] = Color.White;
            backgroundColors[3] = Color.White;
            backgroundColors[4] = Color.White;

            // track colors
            trackColors[0] = Color.FromArgb(204, 204, 204);
            trackColors[1] = Color.FromArgb(220, 220, 220);

            arrowBorderColors[0] = Color.FromArgb(255, 196, 177, 118);
            arrowBorderColors[1] = Color.FromArgb(255, 196, 177, 118);
            arrowBorderColors[2] = Color.FromArgb(255, 196, 177, 118);
            arrowBorderColors[3] = Color.FromArgb(255, 196, 177, 118);
        }
           ...
           ScrollBarOrientation orientation)
        {
            ...
            // get grip image
            using (Image gripImage = Resource.GripNormal)
            {
        ...
        private Rectangle AdjustThumbGrip(
           Rectangle rect,
           ScrollBarOrientation orientation,
           Image gripImage)
        {
        ...
        /// <param name="rect">The rectangle in which to paint.</param>
        /// <param name="state">The <see cref="ScrollBarState"/> of the thumb.</param>
        private void DrawThumbVertical(
           Graphics g,
           Rectangle rect,
           ScrollBarState state)
        {
        ...
        /// <param name="rect">The rectangle in which to paint.</param>
        /// <param name="state">The <see cref="ScrollBarState"/> of the thumb.</param>
        private void DrawThumbHorizontal(
           Graphics g,
           Rectangle rect,
           ScrollBarState state)
        {
        ...
        /// <param name="state">The <see cref="ScrollBarArrowButtonState"/> of the arrow button.</param>
        /// <param name="arrowUp">true for an up arrow, false otherwise.</param>
        private void DrawArrowButtonVertical(
           Graphics g,
           Rectangle rect,
           ScrollBarArrowButtonState state,
           bool arrowUp)
        ...
        /// <param name="state">The <see cref="ScrollBarArrowButtonState"/> of the arrow button.</param>
        /// <param name="arrowUp">true for an up arrow, false otherwise.</param>
        private void DrawArrowButtonHorizontal(
           Graphics g,
           Rectangle rect,
           ScrollBarArrowButtonState state,
           bool arrowUp)
        ...
        private Image GetArrowDownButtonImage(
           ScrollBarArrowButtonState state)
        {
            ...
            using (Graphics g = Graphics.FromImage(bitmap))
            {
                ...
                using (Image arrowIcon = Resource.ScrollBarArrowDown)
                {
