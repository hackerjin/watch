...
namespace Skyray.Controls
{
    ...
    /// </summary>
    public class Office2007SilverRenderer : ISkyrayControl
    {
        ...
        /// </summary>
        public Office2007SilverRenderer()
        {
            // hot state
            ...
            thumbColors[0, 4] = Color.FromArgb(200, 229, 232, 244);
            thumbColors[0, 5] = Color.FromArgb(200, 218, 221, 232);
            thumbColors[0, 6] = Color.FromArgb(200, 199, 201, 211);
            ...
            backgroundColors[3] = Color.FromArgb(238, 238, 238);//main
