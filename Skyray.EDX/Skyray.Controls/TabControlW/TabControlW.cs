...
{
    public class TabControlW : TabControl,ISkyrayStyle
    {
        #region Fields
        ...
        private Color _borderColor = Color.FromArgb(227, 239, 255);
        ...
        private void DrawDrawBackgroundAndHeader(Graphics g)
        {
            ...
            //using (Brush brush = new LinearGradientBrush(headerRect, Color.FromArgb(227, 239, 255), Color.FromArgb(175, 210, 255), LinearGradientMode.Vertical))
            //{
            //    g.FillRectangle(brush, headerRect);
            //}
            //using (Brush brush = new LinearGradientBrush(ClientRectangle, Color.FromArgb(227, 239, 255), Color.FromArgb(175, 210, 255), LinearGradientMode.Vertical))
            //{
            //    g.FillRectangle(brush, ClientRectangle);
            //}
        }
        ...
        private void DrawTabPages(Graphics g)
        {
            ...
            for (int index = 0; index < base.TabCount; index++)
            {
                ...
                else//自定义
                {
                    ...
                    if (_Style == Style.Office2007Blue)
                    {
          ...
          LinearGradientMode mode, Color[] colors0)
        {
            using (GraphicsPath path = CreateTabPath(rect))
            {
                   ...
                   rect, Color.Transparent, Color.Transparent, mode))
                {
                    ...
                    ////colors[1] = Color.FromArgb(218, 219, 231);
                    ////colors[2] = Color.FromArgb(199, 203, 209);
                    //colors[0] = Color.FromArgb(227, 239, 255);
                    //colors[1] = Color.FromArgb(199, 224, 255);
                    //colors[2] = Color.FromArgb(173, 209, 255);
                    //ColorBlend blend = new ColorBlend();
                    //blend.Positions = new float[] { 0.0f, basePosition, 1.0f };
                    //blend.Colors = colors;
                    //brush.InterpolationColors = blend;
                    //g.FillPath(brush, path);
                }
        ...
        public void SetStyle(Style style)
        {
            switch (style)
            {
                case Style.Office2007Blue:
                    this._borderColor = Color.FromArgb(255, 101, 147, 207);
                    this.Refresh();
                    break;
                case Style.Office2007Sliver:
                    this._borderColor = Color.FromArgb(255, 111, 112, 116);
                    this.Refresh();
                    break;
