...
namespace Skyray.Controls
{
   ...
   iujkhjjkjkhkhjjj
    ...
    public class SkinFormProfessionalRenderer : SkinFormRenderer
    {
        ...
        public override Region CreateRegion(FrmSkyray form)
        {
        ...
        public override void InitSkinForm(FrmSkyray form)
        {
            ...
            SkinFormCaptionRenderEventArgs e)
        {
            ...
            using (SolidBrush sbrush = new SolidBrush(Color.FromArgb(0, 0, 0, 0)))
            {
            ...
            Graphics g, Rectangle captionRect, bool active)
        {
            Color baseColor = active ?
                SkinFormColorTable.CaptionActive : ColorTable.CaptionDeactive;
            ...
            Graphics g, Rectangle rect,RoundStyle roundStyle, int radius)
        {
            ...
            {
                using (Pen pen = new Pen(SkinFormColorTable.Border))
                {
                    g.DrawPath(pen, path);
                }
            }
