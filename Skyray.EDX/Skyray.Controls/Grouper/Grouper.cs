...
namespace Skyray.Controls
{
    ...
    public class Grouper : System.Windows.Forms.UserControl
    {
        ...
        private bool V_ShowTileRectangle = false;//是否绘制标题边框

        private GroupBoxAlignMode V_GroupBoxAlignMode = GroupBoxAlignMode.Left;//标题边框对齐方式
        private int V_XTrans = 0;//记录平移距离
        private int V_TextLineSpace = 2;//标题框内文本与GroupBox左右上边线距离
        private int V_TitleLeftSpace = 18;//标题框内图片与GroupBox左右上边线距离
        ...
        private void PaintGroupText(System.Drawing.Graphics g)
        {
            ...
            V_XTrans = intMidX - intMidX1 - ArcX1;//X坐标平移距离
