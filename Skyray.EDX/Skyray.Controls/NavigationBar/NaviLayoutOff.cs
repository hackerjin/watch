    ...
    public class NaviLayoutOff : NaviLayout
    {
        ...
        private void LayoutBands()
        {
            ...
            if (Bar.Collapsed)
            {
                ...
                collapsedBand.Text = Bar.ActiveBand == null ? "" : Bar.ActiveBand.Text;
            }
        ...
        private void InitializeMenu()
        {
            ...
            //this.miShowMoreButtons.Image = Properties.Resources.Up;
            ...
            // this.miShowLessButtons.Image = Properties.Resources.Down;
