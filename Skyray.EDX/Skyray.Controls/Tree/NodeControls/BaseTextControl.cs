...
namespace Skyray.Controls.Tree.NodeControls
{
    public abstract class BaseTextControl : EditableControl
    {
        ...
        protected BaseTextControl()
        {
            ...
            _focusPen = new Pen(Color.Black);//聚焦虚线框，颜色：黑色
        ...
        public override void Draw(TreeNodeAdv node, DrawContext context)
        {
            ...
            {
                context.Graphics.FillRectangle(Brushes.Red, focusRect);//绘制Node选中时背景
                //context.Graphics.FillRectangle(backgroundBrush, focusRect);//绘制Node选中时背景
            }
