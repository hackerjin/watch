...
namespace Skyray.Controls
{
    ...
    public class ToolTipW : ToolTip
    {
        ...
        public ToolTipW(IContainer cont)
            : base(cont)
        {
            InitOwnerDraw();
        }
        ...
        private void TipCapture()
        {
            ...
            WinMethod.GetWindowRect(handle, out rect);
            ...
            IntPtr pD = WinMethod.GetDesktopWindow();
            IntPtr pH = WinMethod.GetDC(pD);

            WinMethod.BitBlt(
                _backDc.Hdc, 
                0, 0, size.Width, size.Height, 
                pH, rect.Left, rect.Top, 0xCC0020);
            WinMethod.ReleaseDC(pD, pH);
        }
