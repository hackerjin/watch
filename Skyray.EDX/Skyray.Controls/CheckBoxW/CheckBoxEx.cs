...
namespace Skyray.Controls
{
    ...
    public class CheckBoxEx : CheckBox,ISkyrayStyle
    {
        ...
        public void SetStyle(Style style)
        {
            switch (style)
            {
                case Style.Office2007Blue:
                    this._baseColor = Color.FromArgb(121, 153, 194);
                    this.Refresh();
                    break;
                case Style.Office2007Sliver:
                    this._baseColor = Color.FromArgb(111, 112, 116);
                    this.Refresh();
                    break;
        ...
        #endregion
        private Color _baseColor = Color.FromArgb(121, 153, 194);
            ...
            if (Enabled)
            {
                switch (ControlState)
                {
                    case ControlState.Hover:
                        ...
                        borderColor = Color.FromArgb(255, 255, 218, 114);
                        innerBorderColor = Color.FromArgb(255, 255, 218, 114);
                    ...
                    case ControlState.Pressed:
                        ...
                        borderColor = Color.FromArgb(255, 255, 182, 88);
                        innerBorderColor = Color.FromArgb(255, 255, 182, 88);
                        checkColor = GetColor(_baseColor, 0, -35, -24, -9);
                        hover = true;
                        break;
                    default:
