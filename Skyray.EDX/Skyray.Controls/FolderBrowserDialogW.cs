...
namespace Skyray.Controls
{
    ...
    /// </summary>
    public sealed class FolderBrowserDialogW : Component
    {
        ...
        {
            IMalloc malloc;
            WinMethod.SHGetMalloc(out malloc);
            return malloc;
        }
        ...
        public DialogResult ShowDialog(IWin32Window owner)
        {
            ...
            {
                hWndOwner = WinMethod.GetActiveWindow();
            }

            // Get the IDL for the specific startLocation.
            WinMethod.SHGetSpecialFolderLocation(hWndOwner, (int)startLocation, out pidlRoot);
            ...
            try
            {
                ...
                // Show the dialog.
                pidlRet = WinMethod.SHBrowseForFolder(ref bi);
                ...
                if (0 == WinMethod.SHGetPathFromIDList(pidlRet, sb))
                {
                    return DialogResult.Cancel;
                }
