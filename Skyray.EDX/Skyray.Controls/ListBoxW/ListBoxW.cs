...
namespace Skyray.Controls
{
    ...
    public class ListBoxW : ListBox, ISkyrayStyle
    {
        #region 私有变量
        private Color _rowBackColor1 = Color.White;//颜色1
        private Color _rowBackColor2 = Color.White;//颜色2
        private Color _selectedColor = Color.FromArgb(255, 218, 114);//选择颜色
        private BorderDrawer borderDrawer = new BorderDrawer();//边框绘制器
        #endregion
            ...
            : base()
        {
            ...
            base.ItemHeight = 17;
            BorderColor = Color.FromArgb(121, 153, 194);//BorderColor
        }
        ...
        {
            base.WndProc(ref m);
            borderDrawer.DrawBorder(ref m, BorderColor, base.Width, base.Height);
        }
